...
export default {
  ...
  methods: {
    ...
    async addComment(crime) {
      ...
      try {
        const response = await axios.post("https://ggg-n4vt.onrender.com/comment", {
          crimeId: crime._id,
          commentText,
          userEmail,
        });
    ...
    async addReply(comment) {
      ...
      try {
        const response = await axios.post(
          `https://ggg-n4vt.onrender.com/comment/${comment._id}/reply`,
          { userEmail, replyText }
        );
    ...
    async fetchUserData() {
      try {
        const res = await axios.get("https://ggg-n4vt.onrender.com/user", {
